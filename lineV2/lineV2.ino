...
for (int i=0;i<7;i++)
{x[i]=y[i]>((mn[i]+mx[i])/2)?0:1;/// 1:0 for white and 0:1 for black
}
for (int i=0;i<7;i++)
{data|=x[i]<<i;/// 1:0 for white and 0:1 for black
}
...
//   y[6]= g(B01000000);
 ...
 //  {char m=Serial.read();
   //if ('m'==m)
 // { 
//Serial.print(1000000/(st-lt));Serial.print(x[0]);Serial.print(" ");Serial.print(x[1]);Serial.print(" ");Serial.print(x[2]);Serial.print(" ");Serial.print(x[3]);Serial.print(" ");Serial.print(x[4]);Serial.print(" ");Serial.print(x[5]);Serial.print(" ");Serial.print(x[6]);Serial.print(" ----- ");Serial.print("----");Serial.print(y[0]);Serial.print(" ");Serial.print(y[1]);Serial.print(" ");Serial.print(y[2]);Serial.print(" ");Serial.print(y[3]);Serial.print(" ");Serial.print(y[4]);Serial.print(" ");Serial.print(y[5]);Serial.print(" ");Serial.println(y[6]);
lt=micros();
